                    ...
                    {open && (
                        ...
                        >
                            <div
                                ...
                                onClick={() => setOpen(!open)}
                            >
                                <IconX className='text-neutral-800' />
                            </div>
                            {children}
                        </motion.div>
                    )}
    ...
    return (
        ...
        >
            ...
            <motion.span
                ...
                className="text-neutral-800  text-sm group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre font-medium inline-block !p-0 !m-0"
            >
                {link.label}
            </motion.span>
        </Link>
